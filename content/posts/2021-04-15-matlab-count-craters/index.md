---
title: "MATLAB Image Processing Toolboxを使ってクレーターを数える"
date: "2021-04-15"
categories:
  - "Tech"
tags:
...
## 参考
- [外観検査: 画像から寸法・個数を瞬時に測定 (ワッシャーの検出)](https://jp.mathworks.com/videos/appearance-check-measuring-size-and-count-washer-120567.html)
- [エッジ検出とモルフォロジーを使用した細胞の検出](https://jp.mathworks.com/help/images/detecting-a-cell-using-image-segmentation.html)
